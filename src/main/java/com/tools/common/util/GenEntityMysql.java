...
public class GenEntityMysql {
     ...
     * 作者名字
     */
    private String authorName = "小柒2012";
    /**
     * 根据表明创建entity实例类,每次一个
     */
    private String tableName = "app_short_url";
    ...
    private String parseRepository() {
        ...
        sb.append("import org.springframework.data.jpa.repository.ftl.JpaRepository;" + "\r\n");
        ...
        sb.append("public interface " + this.allInitialCapital(tableName) + "Repository extends JpaRepository<" + this.allInitialCapital(tableName) + ", Integer> {\r\n");
        sb.append("}\r\n");
